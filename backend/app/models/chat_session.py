...
class ChatSession(Base):
    ...
    user_persona_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("user_personas.id"))
    ...
    user_persona = relationship("UserPersona")
    messages = relationship("ChatMessage", back_populates="session", cascade="all, delete-orphan")

    __table_args__ = (
        CheckConstraint("status IN ('active', 'archived', 'deleted')", name="ck_session_status"),
