...
from app.api.admin.debate import agents, matches, seasons, stats, templates, tournaments
...
router.include_router(stats.router, tags=["admin-debate-stats"])
...
__all__ = ["agents", "matches", "router", "seasons", "stats", "templates", "tournaments"]
